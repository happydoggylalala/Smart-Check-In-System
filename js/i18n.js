...
const dict = {
  ...
  'events.lotteryDetailHint': { 'zh-TW': '抽獎不需要事先設定，活動建立後至「活動抽獎」頁面即可抽獎。', en: 'No setup needed — draw winners from the Lottery page after the event is created.', 'zh-CN': '抽奖不需要事先设置，活动建立后至「活动抽奖」页面即可抽奖。', ja: '事前設定は不要です。イベント作成後「抽選」ページで抽選できます。' },
