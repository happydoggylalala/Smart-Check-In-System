...
const dict = {
  ...
  'lottery.fieldPrizeName': { 'zh-TW': '獎項名稱 *', en: 'Prize name *', 'zh-CN': '奖项名称 *', ja: '賞品名 *' },
  'lottery.fieldPrizeQuantity': { 'zh-TW': '數量 *', en: 'Quantity *', 'zh-CN': '数量 *', ja: '数量 *' },
  'lottery.addPrizeBtn': { 'zh-TW': '新增獎項', en: 'Add prize', 'zh-CN': '新增奖项', ja: '賞品を追加' },
  'lottery.noPrizesYet': { 'zh-TW': '尚未新增獎項', en: 'No prizes added yet', 'zh-CN': '尚未新增奖项', ja: 'まだ賞品がありません' },
  'lottery.prizeQuantityLabel': { 'zh-TW': '{{n}} 份', en: '{{n}} available', 'zh-CN': '{{n}} 份', ja: '{{n}}個' },
  'lottery.errPrizeName': { 'zh-TW': '請輸入獎項名稱', en: 'Please enter a prize name', 'zh-CN': '请输入奖项名称', ja: '賞品名を入力してください' },
  'lottery.errPrizeQuantity': { 'zh-TW': '請輸入至少 1 的數量', en: 'Please enter a quantity of at least 1', 'zh-CN': '请输入至少 1 的数量', ja: '数量は1以上を入力してください' },
  'lottery.selectPrizeLabel': { 'zh-TW': '選擇獎項', en: 'Select prize', 'zh-CN': '选择奖项', ja: '賞品を選択' },
  'lottery.prizeProgress': { 'zh-TW': '已抽出 {{drawn}} / {{quantity}} 份', en: 'Drawn {{drawn}} / {{quantity}}', 'zh-CN': '已抽出 {{drawn}} / {{quantity}} 份', ja: '抽選済み {{drawn}} / {{quantity}}' },
  'lottery.prizeSoldOut': { 'zh-TW': '此獎項名額已抽完', en: 'This prize has no quantity left', 'zh-CN': '此奖项名额已抽完', ja: 'この賞品は在庫がありません' },
  'lottery.noPrizeSelected': { 'zh-TW': '請先新增並選擇一個獎項', en: 'Please add and select a prize first', 'zh-CN': '请先新增并选择一个奖项', ja: '先に賞品を追加して選択してください' },
  'lottery.managePrizesHeading': { 'zh-TW': '獎項設定', en: 'Prizes', 'zh-CN': '奖项设置', ja: '賞品設定' },
  'lottery.deletePrizeBtn': { 'zh-TW': '刪除獎項', en: 'Delete prize', 'zh-CN': '删除奖项', ja: '賞品を削除' },
  'lottery.wonPrizeLabel': { 'zh-TW': '中獎獎項', en: 'Prize won', 'zh-CN': '中奖奖项', ja: '当選賞品' },
